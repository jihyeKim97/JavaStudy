 ...
 */
public class Librarian_backup2 {
	// 데이터/ 상수필드
...
//	} // 각 변수필드를 각각의 데이터형의 기본값으로 초기화
	public Librarian_backup2() {
		...
		//
		this.libNum = 0;
		this.joinDay = new Date(); // 실행된 날자시간 ..GMT + 9; KST
	...
	public Librarian_backup2(String name, int age, int gender,
...
//		(this.gender == 1 ? "여성" : "남성") + "]" );
		...
		// 날자시간 객체를 사용자정의(custom) 서식으로 출력하기
		SimpleDateFormat sdf =
				new SimpleDateFormat("yyyy년 MM월 dd일");
				//new SimpleDateFormat("oooo년 oo월 oo일");
		String wantDate = sdf.format(this.joinDay);
		System.out.println("\t * 입사일: " + wantDate);
		//System.out.println("\t * 입사일: " + this.joinDay);
		// Wed Apr 07 13:39:26 KST 2021
		System.out.println("\t * 직급: " + this.pos);
		System.out.println("\t * 담당직무: " + this.major);
		System.out.println("------------------------------"); 
	}
