...
//	public Book() {} // 기본생성자는 (클래스내 생성자가 하나도 없을 때 생략가능)
	public Book_backup4() {} // 각 변수필드들은 자신의 타입의 기본값으로 자동초기화..

	// 중간 생성자 (필드들의 일부만 가지고 객체를 우선 만들기)
	
	public Book_backup4(String title, String author ) {
		this.title = title;
		this.author = author; 
		this.comment = Book_backup4.NO_COMMENT;
	...
	public Book_backup4(String atitle, String aauthor,int apublisher) {
		title = atitle;
		author = aauthor;
...
//		comment = null;// 자동초기화됨.
	...
	public Book_backup4(int no, String atitle, String aauthor,
			int apublisher) {
		title = atitle;
		author = aauthor;
		publisher = apublisher;
