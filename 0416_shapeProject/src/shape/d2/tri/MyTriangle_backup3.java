 ...
 */
public class MyTriangle_backup3 {
	// 필드
	...
	// 배열의 길이가 3이상이 아니면.. 에러!!
	public MyTriangle_backup3(MyPoint[] pts) {
...
//				new MyLine(pts[2], pts[0], "삼각형 선분 CA"));
	...
	public MyTriangle_backup3(int ptAX, int ptAY, 
	...
	// (주어진 3개 점객들로 구성된 선분 객체 3개를 동적으로 new 생성)
	public MyTriangle_backup3(MyPoint ptA, MyPoint ptB, MyPoint ptC) {
		this(ptA, ptB, ptC, 
...
//		this.color = color;
	...
	// 풀 생성자 shift + alt + s
	public MyTriangle_backup3(MyPoint ptA, MyPoint ptB, MyPoint ptC, MyLine lnAB, MyLine lnBC, MyLine lnCA, String tag,
