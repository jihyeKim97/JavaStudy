...
import ui.calendar.main.db.data.Member;
...
public class GuiCalendarFrame6 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GuiCalendarFrame6 frame = new GuiCalendarFrame6();
...
//		System.out.println("============================"); // 28
	 ...
	 * Create the frame.
	 */
	public GuiCalendarFrame6() {
		this(1970, 1); // epoch
	}
	
	public GuiCalendarFrame6(int year, int month) {
		//setTitle("GUI \uCE98\uB9B0\uB354");
		setTitle("GUI \uCE98\uB9B0\uB354 " 
					+ Member.loggedIn + "로 로그인 중...");
