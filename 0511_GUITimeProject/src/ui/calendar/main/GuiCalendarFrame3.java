...
public class GuiCalendarFrame3 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GuiCalendarFrame3 frame = new GuiCalendarFrame3();
...
//		System.out.println("============================"); // 28
	 ...
	 * Create the frame.
	 */
	public GuiCalendarFrame3() {
		this(1970, 1); // epoch
	}
	
	public GuiCalendarFrame3(int year, int month) {
		setTitle("GUI \uCE98\uB9B0\uB354");
