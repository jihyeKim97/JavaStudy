...
public class GuiCalendarFrame5 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GuiCalendarFrame5 frame = new GuiCalendarFrame5();
...
//		System.out.println("============================"); // 28
	 ...
	 * Create the frame.
	 */
	public GuiCalendarFrame5() {
		this(1970, 1); // epoch
	}
	
	public GuiCalendarFrame5(int year, int month) {
		setTitle("GUI \uCE98\uB9B0\uB354");
