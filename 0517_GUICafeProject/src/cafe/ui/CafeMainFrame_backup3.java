...
public class CafeMainFrame_backup3 extends JFrame {
...
//	private JPanel contentPane; // 일반 패널
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CafeMainFrame_backup3 frame = new CafeMainFrame_backup3();
