...
public class CafeAdminFrame_backup2 extends JFrame {

	private JPanel contentPane;
	private JTable tableFoods;
	CafeAdminFrame_backup2 frm;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CafeAdminFrame_backup2 frame = new CafeAdminFrame_backup2();
