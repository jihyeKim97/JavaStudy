...
public class JMemoFrame8 extends JFrame {
	// 컬러 선택
...
//				if(  rdColor.getText().equals("검정")) {}
				...
				case "파랑":
					...
					break;
				case "초록":
					activeColor = CR_GREEN;
					break;
				case "주황":
					activeColor = CR_ORANGE;
					break;
				default:
	...
	// 폰트
	public static final String[] FONT_NAMES = { "Arial", "Book Antiqua", "Georgia", "Courier New", "나눔고딕", "굴림", "바탕",
			"궁서", "나눔바른펜" };
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					JMemoFrame8 frame = new JMemoFrame8();
	...
	public JMemoFrame8() {
		setIconImage(
				Toolkit.getDefaultToolkit().getImage("C:\\dev2021\\java_ws\\GUIMemoProject\\icons\\script_edit.png"));
		setTitle("My \uBA54\uBAA8\uC7A5");
		...
		textArea.setFont(new Font(FONT_NAMES[DEF_SEL_FONT], DEF_FONT_OPT, DEF_FONTSIZE)); // 기본폰트 속성들
